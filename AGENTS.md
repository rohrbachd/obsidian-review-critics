...
- 001-review-workflow: Added TypeScript 5.x (strict mode), Node.js 22 runtime for build tooling + Obsidian API, CodeMirror 6 (`@codemirror/view`, `@codemirror/state`), esbuild
